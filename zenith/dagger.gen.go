...
func (r *Cloud) About(ctx context.Context) (string, error) {
	if r.about != nil {
		return *r.about, nil
	}
	q := r.q.Select("about")
...
func (r *Cloud) URL(ctx context.Context) (string, error) {
	if r.url != nil {
		return *r.url, nil
	}
	q := r.q.Select("url")
...
type WithEngineFunc func(r *Engine) *Engine

// With calls the provided function with current Engine.
//
// This is useful for reusability and readability by not breaking the calling chain.
func (r *Engine) With(f WithEngineFunc) *Engine {
	return f(r)
}

func (r *Engine) Arches(ctx context.Context) ([]string, error) {
	q := r.q.Select("arches")
...
// EngineCliOpts contains options for Engine.Cli
type EngineCliOpts struct {
...
func (r *Engine) Cli(opts ...EngineCliOpts) *File {
	q := r.q.Select("cli")
	for i := len(opts) - 1; i >= 0; i-- {
...
func (r *Engine) FromZenithBranch() *Engine {
	q := r.q.Select("fromZenithBranch")
...
func (r *Engine) GoBase() *Container {
	q := r.q.Select("goBase")
...
func (r *Engine) Oses(ctx context.Context) ([]string, error) {
	q := r.q.Select("oses")
...
func (r *Engine) Source() *Directory {
	q := r.q.Select("source")
...
func (r *Engine) SourceBranch(ctx context.Context) (string, error) {
	if r.sourceBranch != nil {
		return *r.sourceBranch, nil
	}
	q := r.q.Select("sourceBranch")
...
func (r *Engine) SourceRepo(ctx context.Context) (string, error) {
	if r.sourceRepo != nil {
		return *r.sourceRepo, nil
	}
	q := r.q.Select("sourceRepo")
...
type WithWorkerFunc func(r *Worker) *Worker

// With calls the provided function with current Worker.
//
// This is useful for reusability and readability by not breaking the calling chain.
func (r *Worker) With(f WithWorkerFunc) *Worker {
	return f(r)
}

func (r *Worker) Arches(ctx context.Context) ([]string, error) {
	q := r.q.Select("arches")
...
func (r *Worker) Buildctl(arch string) *File {
...
func (r *Worker) Cniplugins(arch string) *Directory {
...
func (r *Worker) Container(arch string) *Container {
	q := r.q.Select("container")
	q = q.Arg("arch", arch)
...
func (r *Worker) Containers(ctx context.Context) ([]Container, error) {
	...
	convert := func(fields []containers) []Container {
		...
		for i := range fields {
			out = append(out, Container{id: &fields[i].Id})
		}
...
// The worker daemon
func (r *Worker) Daemon(arch string) *File {
	q := r.q.Select("daemon")
	q = q.Arg("arch", arch)
...
func (r *Worker) DaggerBin(arch string) *File {
...
func (r *Worker) Dnsname(arch string) *File {
...
func (r *Worker) GoBase() *Container {
	q := r.q.Select("goBase")
...
func (r *Worker) Publish(ctx context.Context, ref string) (string, error) {
	if r.publish != nil {
		return *r.publish, nil
	}
	q := r.q.Select("publish")
...
func (r *Worker) QemuBins(arch string) *Directory {
...
func (r *Worker) Runc(arch string) *File {
	q := r.q.Select("runc")
	q = q.Arg("arch", arch)
...
func (r *Worker) Shim(arch string) *File {
	q := r.q.Select("shim")
	q = q.Arg("arch", arch)
...
func (r *Worker) Tests(ctx context.Context) (Void, error) {
	if r.tests != nil {
		return *r.tests, nil
	}
	q := r.q.Select("tests")
...
func (r *Worker) Version(ctx context.Context) (string, error) {
	if r.version != nil {
...
func (r *Worker) WithVersion(version string) *Worker {
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (any, error) {
	...
	case "Zenith":
		...
		case "Update":
			...
			return (*Zenith).Update(&parent, ctx, repo, operatingSystem)
		default:
