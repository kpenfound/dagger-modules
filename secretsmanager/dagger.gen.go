...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (any, error) {
	...
	case "Secretsmanager":
		...
		case "GetSecret":
			...
			return (*Secretsmanager).GetSecret(&parent, name)
		case "PutSecret":
			var err error
			var parent Secretsmanager
			err = json.Unmarshal(parentJSON, &parent)
			...
			return (*Secretsmanager).PutSecret(&parent, name, value)
		case "":
			var err error
			var typeDefBytes []byte = []byte("{\"asObject\":{\"functions\":[{\"args\":[{\"name\":\"key\",\"typeDef\":{\"kind\":\"StringKind\"}},{\"name\":\"secret\",\"typeDef\":{\"kind\":\"StringKind\"}}],\"name\":\"Auth\",\"returnType\":{\"asObject\":{\"name\":\"Secretsmanager\"},\"kind\":\"ObjectKind\"}},{\"args\":[{\"name\":\"name\",\"typeDef\":{\"kind\":\"StringKind\"}}],\"name\":\"GetSecret\",\"returnType\":{\"kind\":\"StringKind\"}},{\"args\":[{\"name\":\"name\",\"typeDef\":{\"kind\":\"StringKind\"}},{\"name\":\"value\",\"typeDef\":{\"kind\":\"StringKind\"}}],\"name\":\"PutSecret\",\"returnType\":{\"asObject\":{\"name\":\"Secretsmanager\"},\"kind\":\"ObjectKind\"}}],\"name\":\"Secretsmanager\"},\"kind\":\"ObjectKind\"}")
